...
def get_omniglot(data_path, way, download):
    ...
    train = ClassSplitter(train,
                          shuffle=True, 
                          num_train_per_class=way, 
                          num_test_per_class=way)

    test = ClassSplitter(test,
                          shuffle=True, 
                          num_train_per_class=way, 
                          num_test_per_class=way)
    return train, test
